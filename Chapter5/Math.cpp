...
const Vector2 Vector2::NegUnitX = Vector2(-1.f, 0.f);
const Vector2 Vector2::NegUnitY = Vector2(0.f, -1.f);
...
const Vector3 Vector3::NegUnitX = Vector3(-1.f, 0.f, 0.f);
const Vector3 Vector3::NegUnitY = Vector3(0.f, -1.f, 0.f);
const Vector3 Vector3::NegUnitZ = Vector3(0.f, 0.f, -1.f);
